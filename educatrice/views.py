...
from .tools import DEFAULT_HIDDEN_FIELDS, DEFAULT_PASSWORD, MSG_CONFIRMER_MODIFICATION, MSG_CONFIRMER_SUPPRESSION, \
    MSG_CREDENTIAL_CORRECT, MSG_CREDENTIAL_INCORRECT, MSG_MOT_DE_PASSE_CONFIRMATION_DIFERENT, \
    MSG_MOT_DE_PASSE_INCORRECT, MSG_OBJET_SUPPRIME, delete_hidden_field
